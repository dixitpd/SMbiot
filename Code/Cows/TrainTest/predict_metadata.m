...
[cms pms] = ((corr(M,metz_test,'type','spearman')));
cms = diag(cms);pms = diag(pms);
cmc = (diag(corr(M',metz_test','type','spearman')));
[mean(cmc) std(cmc)]
[mean(cms) std(cms)]
save metadata_pred_20_0.05 cms;